(ns cam-server.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [cam-server.routes.home :refer [home-routes]]
            [cam-server.middleware :as middleware]
            [cam-server.session :as session]
...
(defn init
  ...
  (timbre/info (str
                 "\n-=[cam-server started successfully"
...
(defn destroy
  ...
  []
  (timbre/info "cam-server is shutting down...")
  (stop-nrepl)
